...
var ConvertDialog = {
  ...
  onLoadDialog: function() {
    ...
    //  data source, if the checkbox for the requested item is enabled.
    var self = this;
  ...
  onCandidatesPageHide: function() {
    ...
    //  ensures that the conversion enumerator is not resumed.
  ...
  /**
   * Shows a file selector allowing the user to select the absolute path of
   *  a folder to be placed in the textbox linked to this control. The "input"
   ...
   *  thrown. If the aMustExist parameter is true, an exception is thrown also

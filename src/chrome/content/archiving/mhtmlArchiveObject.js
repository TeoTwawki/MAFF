 ...
 *                 ends with the ".mht" or ".mhtml" extension.
 */
...
MhtmlArchive.prototype = {
  ...
  extractAll: function() {
    ...
    if (part.headersByLowercaseName["x-maf"] && part.parts) {
      ...
      //  "resource:///" URL is used for the same purpose. Resource URLs are
      //  used only during resolution of relative references, and are never
   ...
   *  the given MIME part, which is a content part. The resource is both added
   *  to the current PersistBundle object and returned by the function.
   */

...
SaveCompletePersist.prototype = {
   ...
   *
   * @param aResultObject.nsresult   Final result code for the operation. If
   *                                  this code is NS_OK, usually no errors are
   *                                  present, but there may be some warnings.
   * @param aResultObject.warnings   Optional array of strings with the warnings
   *                                  to be reported. Warnings are only reported
   *                                  to the Error Console.
   * @param aResultObject.errors     Optional array of strings with the errors
   *                                  to be reported. If present, the progress
   ...
   *
   * @param aMessageArray   Array of strings to be reported. All the strings
   *                         will be reported as a single message. If not
   *                         provided or empty, no message will be reported.
   * @param aIsError        Specify true if the messages are fatal errors, or
   *                         false if they should reported as warnings.
   */

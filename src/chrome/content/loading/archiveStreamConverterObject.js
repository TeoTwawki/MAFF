 ...
 *
 * @param aInnerFactory   If the converter detects that it was not invoked for
 *                         archive loading, and this parameter is not null, it
 *                         will use this class factory to create an object that
 *                         will handle all the calls and interface queries.
 */
...
ArchiveStreamConverter.prototype = {
  ...
  onStopRequest: function(aRequest, aContext, aStatusCode) {
    ...
    if (betterUri) {
      ...
      //  access the contents of the remote resource anymore, but we have to
      //  open the channel anyway in order for the next phase of the document
   ...
   *  should be interpreted as MHTML, or false if the source should be handled
